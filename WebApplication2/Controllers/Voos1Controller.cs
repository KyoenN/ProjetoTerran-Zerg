...
namespace WebApplication2.Controllers
{
    ...
    public class Voos1Controller : ControllerBase
    {
            ...
            DateTime dataHoraPartida)
        {
            ...
            List<Aeroporto> aeroportosOrigem = await _context.Aeroportos.Where(a => a.Cidade == cidadeOrigem)
                .ToListAsync();
            List<Aeroporto> aeroportosDestino = await _context.Aeroportos.Where(a => a.Cidade == cidadeDestino)
                .ToListAsync();
